...
>
    ...
    <button 
        @click="visible = true"
        class="fixed bottom-0 right-0 rounded-full bg-blue-500 text-white px-5 py-3 mb-6 mr-6 z-20 hover:bg-blue-400 transition text-xs uppercase font-semibold lgMin:hidden"
    >
        Reply
    </button>
    ...
    <div 
        ...
        class="absolute w-2/3 bg-white rounded-xl p-6 shadow-dialog top-16 left-0 right-0 lg:hidden z-30"
        @click.away="visible = false"
